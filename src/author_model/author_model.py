...
dbutils.widgets.text("max_full_evals", "2", "Max Full Evaluations for GEPA Optimization")
...
max_full_evals = int(dbutils.widgets.get("max_full_evals"))
